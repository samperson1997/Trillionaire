function loadStraList() {
    $("#stra-table").html("<tr><th>名称</th><th>创建时间</th><th>最新修改时间</th><th>操作</th></tr>");
    var load = $.ajax({
        type: "GET",
        ...
        success: function (data0) {
            $.each(data0.nameList, function (i, value) {
                $("#stra-table").append("<tr><td><a href=\"strategy-edit.html?sid=" + value.sid + "\">" + value.strategName + "</a></td><td>2017-05-25 22:11</td><td>2017-05-25 22:12</td><td><a href=\"strategy-edit.html?sid=" + value.sid + "\"><div class=\"button-green\"><i class=\"fa fa-eye\"></i> 查看</div></a><div class=\"button-red\" id=\"" + value.sid + "delete-button\" onclick=\"deleteStra(this)\"><i class=\"fa fa-close\"></i> 删除</div></td></tr>");
